...
const cacheName = 'Team2FinalProject-2020-10-11 18:20:18.405218'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Team2FinalProject'.length) === 'Team2FinalProject') {
